...
<template>
  <c-card>
    <div mb-2 flex justify-center flex-wrap>
      <img v-for="(card, index) in cardPicked" :key="index" style="width:90px" m-1 :src="`data:image/svg+xml;base64,${cards[card as CardNames]}`">
    </div>
    <div mb-2 style="width:500px">
